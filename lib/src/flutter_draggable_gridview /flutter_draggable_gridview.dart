...
class DraggableGridViewBuilder extends ConsumerStatefulWidget {
  // [listOfWidgets] will show the widgets in Gridview.builder.
  final List<DragItem> listOfWidgets;
  // final List<DragItem> listOfitems;
...
class _DraggableGridViewBuilderState
    extends ConsumerState<DraggableGridViewBuilder> {
  @override
  void initState() {
    super.initState();
    ...
    _showChecks = widget.showChecks;
  }

  @override
  Widget build(BuildContext context) {
    // debugPrint('BUILD ${widget.listOfWidgets.length} ${_list.length}    ');
    // ref.watch(dragItemListProvider.notifier
    //     .select((value) => value.isCheckBoxsActive));
